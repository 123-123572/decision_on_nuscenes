...
# -*- coding: utf-8 -*-
"""
Full v14.0 learned camera-BEV joint planner on nuScenes FULL dataset.

This is a self-contained v14.0 pipeline built on v12.2, upgraded from annotation-BEV consumption to learned camera-BEV generation:
...
class Config:
    ...
    # In v14.0 learned camera-BEV joint, USE_ANNOTATION_BEV should normally be 1 and USE_DENSE_BEV_TOKENS should normally be 0.
    ...
    # v14.0: generate BEV from cached 6-camera features and train it jointly with planner.
    ...
    base_save_subdir: str = os.getenv("BASE_SAVE_SUBDIR", "v14_0_base")
    base_best_model_name: str = "best_v14_0_base_model.pt"
    ...
    save_dir: str = "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v14_0_learned_camera_bev_joint"
    base_ckpt_path: str = os.getenv("BASE_CKPT_PATH", "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v14_0_learned_camera_bev_joint/v14_0_base/best_v14_0_base_model.pt")
    ...
    model_type: str = "transformer_v14_0_learned_camera_bev_joint_full_pipeline"
...
class CameraToBEVGenerator(nn.Module):
    """
    v14.0 lightweight learned camera-BEV generator.
...
class MapAgentEgoPlanner(nn.Module):
    def __init__(
        ...
        # v14.0 learned camera-BEV joint adapters. Input is sampled raw BEV channel vector [C]
...
def train_v8_3_base_if_needed(
    ...
    print("\n" + "=" * 88)
    print("Stage 1: training v14.0 learned camera-BEV joint base model inside this script")
    ...
    for epoch in range(1, CFG.base_epochs + 1):
        ...
        print(
            f"[v14.0 base] Epoch {epoch:03d} | TrainLoss {train_stats['loss']:.4f} | "
        ...
        if improved:
            ...
            ckpt_obj = {
                ...
                "model_type": "transformer_v14_0_learned_camera_bev_joint_base",
                "config": asdict(CFG),
            ...
            print(f"🔥 Saved planning-aware v14.0 BEV base at epoch {epoch} (Macro-F1={macro_f1:.4f}, ADE={ade:.4f}, FDE={fde:.4f}, Gap={gap:.4f}, PlanScore={planning_score:.4f})")
        else:
            patience_counter += 1

        if patience_counter >= CFG.base_early_stop_patience:
            print(f"\n[v14.0 base] Early stopping triggered at epoch {epoch}.")
            break
...
def main():
    ...
    print("=" * 88)
    print("Training: train_transformer_planning_v14_0_learned_camera_bev_joint_full_pipeline")
    ...
    print(f"Frozen base      : v14.0 Learned Camera-BEV Joint planner")
    ...
    for epoch in range(1, CFG.epochs + 1):
        ...
        improved = False
        # v14.0: select the score-calibrated model by planning score, not ADE alone.
