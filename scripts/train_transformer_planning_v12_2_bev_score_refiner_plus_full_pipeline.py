...
class Config:
    ...
    # In v12.2 BEV score-refiner-plus, USE_ANNOTATION_BEV should normally be 1 and USE_DENSE_BEV_TOKENS should normally be 0.
    ...
    base_save_subdir: str = os.getenv("BASE_SAVE_SUBDIR", "v12_2_base")
    base_best_model_name: str = "best_v12_2_base_model.pt"
    ...
    save_dir: str = "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v12_2_bev_score_refiner_plus"
    base_ckpt_path: str = os.getenv("BASE_CKPT_PATH", "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v12_2_bev_score_refiner_plus/v12_2_base/best_v12_2_base_model.pt")
    ...
    model_type: str = "transformer_v12_2_bev_score_refiner_plus_full_pipeline"
...
class MapAgentEgoPlanner(nn.Module):
    def __init__(
        ...
        # v12.2 BEV score-refiner-plus adapters. Input is sampled raw BEV channel vector [C]
...
def train_v8_3_base_if_needed(
    ...
    print("\n" + "=" * 88)
    print("Stage 1: training v12.2 BEV score-refiner-plus base model inside this script")
    ...
    for epoch in range(1, CFG.base_epochs + 1):
        ...
        print(
            f"[v12.2 base] Epoch {epoch:03d} | TrainLoss {train_stats['loss']:.4f} | "
        ...
        improved = False
        # v12.2 planning-aware checkpoint selection:
        ...
        if improved:
            ...
            ckpt_obj = {
                ...
                "model_type": "transformer_v12_2_bev_score_refiner_plus_base",
                "config": asdict(CFG),
            ...
            print(f"🔥 Saved planning-aware v12.2 BEV base at epoch {epoch} (Macro-F1={macro_f1:.4f}, ADE={ade:.4f}, FDE={fde:.4f}, Gap={gap:.4f}, PlanScore={planning_score:.4f})")
        else:
            patience_counter += 1

        if patience_counter >= CFG.base_early_stop_patience:
            print(f"\n[v12.2 base] Early stopping triggered at epoch {epoch}.")
            break
...
def main():
    ...
    print("=" * 88)
    print("Training: train_transformer_planning_v12_2_bev_score_refiner_plus_full_pipeline")
    ...
    print(f"Frozen base      : v12.2 BEV Score-Refiner-Plus planner")
    ...
    for epoch in range(1, CFG.epochs + 1):
        ...
        improved = False
        # v12.2: select the score-calibrated model by planning score, not ADE alone.
