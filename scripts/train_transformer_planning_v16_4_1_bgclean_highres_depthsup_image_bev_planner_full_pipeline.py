...
# -*- coding: utf-8 -*-
"""
Full v16.4.1 high-res depth-supervised bg-cleaned real-image BEV planner on nuScenes, built from v16.4 high-res depth-supervised image-BEV planner.
...
Stage 2 / v16.4.1 score-only calibration:
...
class Config:
    ...
    base_save_subdir: str = os.getenv("BASE_SAVE_SUBDIR", "v16_4_1_base")
    base_best_model_name: str = "best_v16_4_1_base_model.pt"
    ...
    save_dir: str = "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v16_4_1_bgclean_highres_depthsup_image_bev"
    base_ckpt_path: str = os.getenv("BASE_CKPT_PATH", "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v16_4_1_bgclean_highres_depthsup_image_bev/v16_4_1_base/best_v16_4_1_base_model.pt")
    ...
    model_type: str = "transformer_v16_4_1_bgclean_highres_depthsup_image_bev_full_pipeline"
    ...
    for epoch in range(1, CFG.base_epochs + 1):
        ...
        if improved:
            ...
            ckpt_obj = {
                ...
                "model_type": "transformer_v16_4_1_bgclean_highres_depthsup_image_bev_base",
                "config": asdict(CFG),
...
def main():
    ...
    print("=" * 88)
    print("Training: train_transformer_planning_v16_4_1_bgclean_depthsup_image_bev_planner_full_pipeline")
