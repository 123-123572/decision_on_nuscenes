...
# -*- coding: utf-8 -*-
"""
Full v15.0 offline image-BEV cache planner on nuScenes FULL dataset.
...
class Config:
    ...
    use_learned_camera_bev: bool = os.getenv("USE_LEARNED_CAMERA_BEV", "0").lower() in {"1", "true", "yes", "y", "on"}
    ...
    require_real_camera_cache: bool = os.getenv("REQUIRE_REAL_CAMERA_CACHE", "0").lower() in {"1", "true", "yes", "y", "on"}
    ...
    base_save_subdir: str = os.getenv("BASE_SAVE_SUBDIR", "v15_0_base")
    base_best_model_name: str = "best_v15_0_base_model.pt"
    ...
    save_dir: str = "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v15_0_offline_image_bev_cache_planner"
    base_ckpt_path: str = os.getenv("BASE_CKPT_PATH", "/home/ubuntu22/decision_on_nuscenes/outputs_transformer_planning_v15_0_offline_image_bev_cache_planner/v15_0_base/best_v15_0_base_model.pt")
    init_ckpt_path: str = os.getenv("INIT_CKPT_PATH",
                                    "/outputs_transformer_planning_v8_123_intent_behavior/best_model.pt")
    projection_cache_manifest: str = os.getenv("PROJECTION_CACHE_MANIFEST", os.getenv("CAMERA_CACHE_MANIFEST",
                                                                                      "/outputs_v9_5_projection_visual_cache/projection_visual_cache_manifest_v9_5.json"))
    agent3d_cache_manifest: str = os.getenv("AGENT3D_CACHE_MANIFEST",
                                            "/outputs_v10_0_3d_agent_cache/agent3d_cache_manifest_v10_0.json")
    bev_cache_manifest: str = os.getenv("IMAGE_BEV_CACHE_MANIFEST", os.getenv("BEV_CACHE_MANIFEST", "/home/ubuntu22/decision_on_nuscenes/outputs_v15_0_offline_cambev_cache/image_bev_cache_manifest_v15_0.json"))
    best_model_name: str = "best_score_model.pt"
    metrics_name: str = "metrics.json"
    model_type: str = "transformer_v15_0_offline_image_bev_cache_planner"
...
def train_v8_3_base_if_needed(
    ...
    print("\n" + "=" * 88)
    print("Stage 1: training v15.0 offline image-BEV cache planner base model inside this script")
    ...
    for epoch in range(1, CFG.base_epochs + 1):
        ...
        if improved:
            ...
            print(f"🔥 Saved planning-aware v15.0 offline image-BEV base at epoch {epoch} (Macro-F1={macro_f1:.4f}, ADE={ade:.4f}, FDE={fde:.4f}, Gap={gap:.4f}, PlanScore={planning_score:.4f})")
        else:
            patience_counter += 1
...
def main():
    ...
    print("=" * 88)
    print("Training: train_transformer_planning_v15_0_offline_image_bev_cache_planner")
    ...
    if CFG.use_annotation_bev:
        print("Loading offline image-BEV cache...")
        bev_cache = load_annotation_bev_cache(CFG.bev_cache_manifest)
        print(f"Offline image-BEV cache samples: {len(bev_cache)}")
    else:
    ...
    print(f"Offline image-BEV  : {BEV_train.shape}, valid mean={BEVv_train.mean():.4f}")
    ...
    print(f"Frozen base      : v15.0 Offline Image-BEV Cache planner")
